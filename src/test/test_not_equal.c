...
START_TEST(test_not_equal_1) {
  ...
  uint8_t res = s21_is_not_equal(dec1, dec2);
...
Suite *s21_not_equal_cases(void) {
  Suite *c = suite_create("s21_not_equal_cases");
  TCase *tc = tcase_create("s21_not_equal_tc");
  ...
  tcase_add_test(tc, test_not_equal_14);
  tcase_add_test(tc, test_not_equal_15);
  tcase_add_test(tc, test_not_equal_16);
  tcase_add_test(tc, test_not_equal_17);
  tcase_add_test(tc, test_not_equal_18);
