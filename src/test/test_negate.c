...
START_TEST(test_negate_1) {
  ...
  uint8_t flag = s21_negate(dec1, &result);
...
START_TEST(test_negate_3) {
  ...
  s21_decimal result;
  init_with_zero_decimal(&result);
  s21_decimal dec2 = {{0x11111112, 0x11111111, 0x11111111, 0x801B0000}};
...
START_TEST(test_negate_4) {
  ...
  s21_decimal result;
  init_with_zero_decimal(&result);
  s21_decimal dec2 = {{0x11111112, 0x11111111, 0x11111111, 0x001B0000}};
...
START_TEST(test_negate_5) {
  ...
  s21_decimal result;
  init_with_zero_decimal(&result);
  s21_decimal dec2 = {{0xAAAAAAA9, 0xAAAAAAAA, 0x0, 0x00130000}};
...
START_TEST(test_negate_8) {
  ...
  s21_decimal result;
  init_with_zero_decimal(&result);
  s21_decimal dec2 = {{0x1, 0x0, 0x0, 0x001C0000}};
...
START_TEST(test_negate_11) {
  ...
  s21_decimal result;
  init_with_zero_decimal(&result);
  s21_decimal dec2 = {{0x0, 0x0, 0x0, 0x000E0000}};
...
START_TEST(test_negate_12) {
  ...
  s21_decimal result;
  init_with_zero_decimal(&result);
  s21_decimal dec2 = {{0xA, 0x0, 0x0, 0x80010000}};
